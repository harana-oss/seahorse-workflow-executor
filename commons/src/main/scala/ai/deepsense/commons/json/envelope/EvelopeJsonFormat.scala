...
case class EnvelopeJsonWriter[T: JsonWriter](private val label: String) extends RootJsonWriter[Envelope[T]] {
...
case class EnvelopeJsonReader[T: JsonReader](private val label: String) extends RootJsonReader[Envelope[T]] {
...
case class EnvelopeJsonFormat[T: JsonFormat](private val label: String) extends RootJsonFormat[Envelope[T]] {
