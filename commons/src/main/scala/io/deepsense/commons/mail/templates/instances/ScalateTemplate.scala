...
import org.fusesource.scalate.{Template => VendorTemplate}
...
class ScalateTemplate(val scalateTemplateConfig: ScalateTemplateConfig) extends TemplateLoadedFromFile[VendorTemplate] {
