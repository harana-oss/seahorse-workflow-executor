...
import ai.deepsense.deeplang.actionobjects.MissingValuesHandler.{EmptyColumnsStrategy, MissingValueIndicatorChoice}
import ai.deepsense.deeplang.actionobjects.dataframe.DataFrame
import ai.deepsense.deeplang.actionobjects.spark.wrappers.transformers.TransformerSerialization
import ai.deepsense.deeplang.actions.exceptions.{MultipleTypesReplacementException, ValueConversionException}
import ai.deepsense.deeplang.parameters.exceptions.EmptyColumnPrefixNameException
import ai.deepsense.deeplang.parameters.selections.{IndexColumnSelection, IndexRangeColumnSelection, MultipleColumnSelection, TypeColumnSelection}
      ...
      val handler =
        new MissingValuesHandler()
          ...
          .setStrategy(
            MissingValuesHandler.Strategy
              .ReplaceWithMode()
              .setEmptyColumnStrategy(MissingValuesHandler.EmptyColumnsStrategy.RetainEmptyColumns())
          )
          .setMissingValueIndicator(
            MissingValuesHandler.MissingValueIndicatorChoice
              .Yes()
      ...
      val resultDf        = executeTransformer(
        new MissingValuesHandler()
          ...
          .setStrategy(
            MissingValuesHandler.Strategy
              .ReplaceWithMode()
              .setEmptyColumnStrategy(MissingValuesHandler.EmptyColumnsStrategy.RemoveEmptyColumns())
          ),
        df
      )
