...
import io.deepsense.deeplang.doperables.wrappers.EstimatorWrapper
import io.deepsense.deeplang.doperables.wrappers.EvaluatorWrapper
...
import io.deepsense.deeplang.DOperation3To1
...
case class GridSearch()
    extends DOperation3To1[Estimator[Transformer], DataFrame, Evaluator, Report]
