...
import io.deepsense.deeplang.doperables.spark.wrappers.models.DecisionTreeClassificationModel
...
class VanillaDecisionTreeClassifier
  ...
  override val params: Array[Param[_]] = Array(
    ...
    impurity, labelColumn, featuresColumn, probabilityColumn, rawPredictionColumn, predictionColumn
  )
