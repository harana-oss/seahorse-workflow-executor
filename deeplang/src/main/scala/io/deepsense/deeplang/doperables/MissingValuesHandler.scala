...
import io.deepsense.deeplang.doperations.exceptions.MultipleTypesReplacementException
import io.deepsense.deeplang.doperations.exceptions.ValueConversionException
...
case class MissingValuesHandler() extends Transformer {
  ...
  val strategy = ChoiceParam[Strategy](name = "strategy", description = Some("Strategy of handling missing values."))
  ...
  val userDefinedMissingValues =
    ParamsSequence[UserDefinedMissingValue](
...
object MissingValuesHandler {
  ...
  object Strategy {
    ...
    case class ReplaceWithCustomValue() extends Strategy {
      ...
      val customValue = StringParam(name = "value", description = Some("Replacement for missing values."))
    ...
    case class ReplaceWithMode() extends Strategy {
      ...
      val emptyColumnStrategy =
        ChoiceParam[EmptyColumnsStrategy](
