...
trait DataFrameColumnsGetter {
  ...
  /** Returns name of column based on selection. Throws
    * [[io.deepsense.deeplang.doperations.exceptions.ColumnDoesNotExistException ColumnDoesNotExistException]] if
  ...
  /** Names of columns selected by provided selections. Order of returned columns is the same as in schema. If a column
    ...
    * [[io.deepsense.deeplang.doperations.exceptions.ColumnDoesNotExistException ColumnsDoNotExistException]] if
...
object DataFrameColumnsGetter {
  ...
  /** Throws [[io.deepsense.deeplang.doperations.exceptions.WrongColumnTypeException WrongColumnTypeException]] if
  ...
  /** Names of columns selected by provided selections. Order of returned columns is the same as in schema. If a column
    * will occur in many selections, it won't be duplicated in result. Throws
    * [[io.deepsense.deeplang.doperations.exceptions.ColumnsDoNotExistException ColumnsDoNotExistException]] if
    * out-of-range indexes or non-existing column names are selected.
    */
