...
class ALS
  ...
  val implicitPrefs =
    new BooleanParamWrapper[SparkALS](
      name = "implicit prefs",
  ...
  val ratingColumn =
    new SingleColumnSelectorParamWrapper[SparkALS](
      name = "rating column",
  ...
  override val params: Array[Param[_]] = Array(
    alpha, checkpointInterval, implicitPrefs, maxIterations, nonnegative, numItemBlocks, numUserBlocks, rank,
    ratingColumn, regularizationParam, seed, itemColumn, predictionColumn, userColumn
  )
