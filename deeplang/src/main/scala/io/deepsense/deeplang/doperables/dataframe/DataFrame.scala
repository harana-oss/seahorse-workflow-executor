...
/** @param sparkDataFrame
  ...
  *   schema is known.
  */
case class DataFrame private[dataframe] (sparkDataFrame: sql.DataFrame, schema: Option[StructType])
    extends DOperable
...
object DataFrame {
  ...
  /** Throws [[io.deepsense.deeplang.doperations.exceptions.WrongColumnTypeException WrongColumnTypeException]] if some
