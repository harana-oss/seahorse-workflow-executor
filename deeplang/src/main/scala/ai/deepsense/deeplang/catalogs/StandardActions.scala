...
import ai.deepsense.deeplang.ActionCategories._
...
import ai.deepsense.deeplang.actions.spark.wrappers.estimators._
import ai.deepsense.deeplang.actions.spark.wrappers.evaluators._
import ai.deepsense.deeplang.actions.spark.wrappers.transformers._

/** Class responsible for registering the default built-in set of Seahorse operations. */
class StandardActions extends CatalogRegistrant {
