...
/** Catalog of DOperations. Allows to register DOperations under specified categories, to browse categories structure
...
object DOperationsCatalog {
  ...
  private class DOperationsCatalogImpl() extends DOperationsCatalog {
    ...
    def registeredOperations: Seq[(DOperationCategory, OperationFactory, SortPriority)] =
      categoryTree.getOperations.map { case (category: DOperationCategory, id: DOperation.Id, priority: SortPriority) =>
