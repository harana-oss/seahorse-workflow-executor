...
import ai.deepsense.deeplang.params.selections.MultipleColumnSelectionProtocol._

case class ColumnSelectorParam(override val name: String, override val description: Option[String], portIndex: Int)
