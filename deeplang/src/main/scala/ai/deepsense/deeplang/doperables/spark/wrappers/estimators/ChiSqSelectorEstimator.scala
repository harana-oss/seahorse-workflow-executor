...
class ChiSqSelectorEstimator
  ...
  val numTopFeatures = new IntParamWrapper[ml.param.Params { val numTopFeatures: ml.param.IntParam }](
  ...
  override val params: Array[Param[_]] = Array(numTopFeatures, featuresColumn, outputColumn, labelColumn)
