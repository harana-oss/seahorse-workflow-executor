...
case class Join()
  ...
  val joinType = ChoiceParam[JoinTypeChoice.Option](name = "join type", description = Some("Type of join operation."))
  ...
  val specificParams: Array[ai.deepsense.deeplang.params.Param[_]] =
