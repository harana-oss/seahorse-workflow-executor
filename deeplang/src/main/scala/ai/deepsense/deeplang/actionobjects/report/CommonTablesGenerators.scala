package ai.deepsense.deeplang.actionobjects.report

import scala.language.reflectiveCalls
import scala.util.Try

import ai.deepsense.commons.types.ColumnType
import ai.deepsense.deeplang.actionobjects.report.ReportUtils.formatValues
import ai.deepsense.deeplang.actionobjects.report.ReportUtils.shortenLongTableValues
...
object CommonTablesGenerators {
  ...
  private def paramMapToDescriptionLists(params: ParameterMap, namePrefix: String = ""): List[List[Option[String]]] = {
  ...
  def params(params: ParameterMap): Table = {
