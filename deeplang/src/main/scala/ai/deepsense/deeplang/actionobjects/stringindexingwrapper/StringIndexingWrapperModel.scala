...
abstract class StringIndexingWrapperModel[M <: ml.Model[M], E <: ml.Estimator[M]](
  ...
  override def params: Array[Parameter[_]] = wrappedModel.params
  ...
  override private[deeplang] def paramMap: ParameterMap = wrappedModel.paramMap

  override private[deeplang] def defaultParamMap: ParameterMap = wrappedModel.defaultParamMap
