...
class ParamsSpec extends UnitSpec {
  ...
  "Class with Params" should {
    ...
    "throw Deserialization exception" when {
      "unknown param name is used it should be ignored" in {
        val p = WithParams()
        p.setParamsFromJson(JsObject("unknownName" -> 5.toJson, p.param2.name -> 6.toJson), graphReader)
        p.get1 shouldBe defaultForParam1
      }
    }
  }
  ...
  "Params.extractParamMap" should {
    "return enriched paramMap" in {
      ...
      p.extractParamMap(extraMap) shouldBe ParameterMap(
...
object ParamsSpec extends UnitSpec {
  ...
  case class WithParams() extends Params {
    ...
    val params: Array[Parameter[_]] = Array(param2, param1)
  ...
  case class ParamsWithChoice() extends Params {
    ...
    val choiceParam = ChoiceParameter[ChoiceWithRepeatedParameter](name = "choice", description = Some("choice"))

    def setChoice(v: ChoiceWithRepeatedParameter): this.type = set(choiceParam, v)

    override val params: Array[Parameter[_]] = Array(choiceParam)
  ...
  case class ChoiceOne() extends ChoiceWithRepeatedParameter {
    ...
    val numericParam = NumericParameter(name = "x", description = Some("numericParam"))

    override val params: Array[Parameter[_]] = Array(numericParam)
  ...
  object DeclareParamsFixtures {
    ...
    val outsideParam = MockParameter("outside name")

    class ParamsFromOutside extends Params {

      val param = MockParameter("name")

      val params: Array[Parameter[_]] = Array(outsideParam, param)
    ...
    class ParamsWithNotUniqueNames extends Params {
      ...
      val params: Array[Parameter[_]] = Array(param1, param2)
    ...
    class NotAllParamsDeclared extends Params {
      ...
      val params: Array[Parameter[_]] = Array(param1)
    ...
    class ParamsRepeated extends Params {
      ...
      val params: Array[Parameter[_]] = Array(param1, param2, param1)
