...
class WrappersDefaultValidationSpec extends AnyWordSpec with Matchers with MockitoSugar {
  ...
  "IntParamWrapper" should {
    ...
    val intParamWrapper = new IntParameterWrapper[ExampleSparkParams]("name", Some("description"), _.intSparkParam)
  ...
  "FloatParamWrapper" should {
    ...
    val floatParamWrapper = new FloatParameterWrapper[ExampleSparkParams]("name", Some("description"), _.floatSparkParam)
  ...
  "DoubleParamWrapper" should {
    "validate whole Double range" in {
      val doubleParamWrapper =
        new DoubleParameterWrapper[ExampleSparkParams]("name", Some("description"), _.doubleSparkParam)
