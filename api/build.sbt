import _root_.io.swagger.codegen.ClientOptInput
import _root_.io.swagger.codegen.ClientOpts
import _root_.io.swagger.codegen.CodegenConstants
import _root_.io.swagger.codegen.DefaultGenerator
...
swaggerPackages := Seq(("io.deepsense.api.datasourcemanager", "src/main/resources/datasourcemanager.swagger.json"))

javaSourceManaged := target.value / "java" / "srcManaged"

Compile / managedSourceDirectories += javaSourceManaged.value
Compile / sourceGenerators         += (buildSwaggerClients in Compile).taskValue
