...
import io.deepsense.workflowexecutor.communication.message.workflow.Abort
import io.deepsense.workflowexecutor.communication.message.workflow.Synchronize
import io.deepsense.workflowexecutor.communication.message.workflow.UpdateWorkflow
